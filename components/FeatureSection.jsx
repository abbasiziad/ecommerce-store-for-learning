            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                ...
                <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                            Protect your organization and stay compliant with structured workflows and permissions.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                            Automate tasks, send messages, and use templates to boost productivity.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                            Audit-proof software for financial operations and budgeting.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                            Build beautiful experiences with cross-team collaboration.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                            Keep workflows efficient with customizable and structured processes.
                        </p>
                    </div>
